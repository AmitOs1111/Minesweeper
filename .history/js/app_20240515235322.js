...
function openModalVictory() {
  ...
  elModal.querySelector('h2 span').innerText = elTime

  const elScore = document.querySelector('.score-game').innerText
  elModal.querySelector('h3 span').innerText = elScore
}
